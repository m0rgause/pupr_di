                ...
                <div class="col-md-12 col-lg-12 col-12">
                    <div class="card">
                        ...
                        <div id="collapseCard" class="collapse show">
                            <div class="card-body">
                                <form action="{{ route('admin.ruang.create') }}" method="post" id="form"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="lantai" class="form-label">Lantai</label>
                                        <select class="form-select @error('lantai_id') is-invalid @enderror " id="lantai"
                                            name="lantai_id" required>
                                    ...
                                    <div class="mb-3 desc">
                                        ...
                                        <textarea class="form-control" id="body_desc" name="body_desc" rows="10"></textarea>
                                    </div>
                                    <div class="d-grid">
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex">
                                                 {{-- edit modal --}}
                                                    ...
                                                    <a href="{{ route('admin.ruang.hapus', $r->id) }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editModalLabel{{ $r->id }}">Edit Ruang
                                                            </h5>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action="{{ route('admin.ruang.edit', $r->id) }}"
